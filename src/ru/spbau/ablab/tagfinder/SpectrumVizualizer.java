...
public class SpectrumVizualizer extends JFrame {
	private static final String envFile = StatisticsGeneratorExperimental.SPECTRUM_FILE_SUFFIX.substring(1);
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getActionCommand().equals("open")) {
				...
				if (fileChooser.showOpenDialog(mainFrame) == JFileChooser.APPROVE_OPTION) {
					...
					String str = StatisticsGeneratorExperimental.SPECTRUM_FILE_SUFFIX;
					...
					try {
						...
						double[] intens = fastScanner.getDoubleArray();
						Envelope[] virEnv = new Envelope[masses.length];
						for (int i = 0; i < virEnv.length; ++i) {
							virEnv[i] = new Envelope(masses[i], intens[i], intens[i]);
						}
	...
	public static void main(String[] args) {
		SpectrumVizualizer mainFrame = new SpectrumVizualizer();
